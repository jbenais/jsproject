...
class ProfileInfos extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            birthdate: this.props.data.user_general.birthdate ? (this.props.data.user_general.birthdate).split('T', 1)[0] : '2000-01-01',
            profession: this.props.data.user_general.profession,
            profileList: [],
            orientation: this.props.data.user_general.orientation,
            userProfile: 'ENFJ',
            edit: false,
